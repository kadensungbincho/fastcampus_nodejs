...
exports.get_complete = async (req,res) => {
    ...
    const iamporter = new Iamporter({
        apiKey: '2706554256864306',
        secret: 'hNzPHjk9svFsjYtJOT1wHamHxgjWWhnd4X3MhnVKSBdbzGVnAXUh8gYFxiCtz0HEXKqe7mZ0XcbxS7Vt'
    });
...
exports.get_shipping = async (req,res) => {
    ...
    try{
        ...
        doortodoor.do?fsp_action=PARC_ACT_002&fsp_cmd=retrieveInvNoACT&invc_no=" 
            + req.params.invc_no ;
